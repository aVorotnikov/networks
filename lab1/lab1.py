...
def losing_test():
    ...
    print("\t\\hline")
    print("\t\t & \\multicolumn{2}{|c|}{Go-Back-N} & \\multicolumn{2}{|c|}{Selective Repeat} \\\\ \\hline")
    print("\t\t $p$ & $k$ & $t$ & $k$ & $t$ \\\\ \\hline")
    ...
    ax.legend()
    ax.grid()
    plt.savefig(f'lab1/plots/loss_size_efficiency.png')
    ...
    ax.legend()
    ax.grid()
    plt.savefig(f'lab1/plots/loss_transfer_time.png')
...
def window_test():
    ...
    ax.legend()
    ax.grid()
    plt.savefig(f'lab1/plots/window_size_efficiency.png')
    ...
    ax.legend()
    ax.grid()
    plt.savefig(f'lab1/plots/window_size_transfer_time.png')
